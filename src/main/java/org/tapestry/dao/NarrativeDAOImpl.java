...
public class NarrativeDAOImpl implements NarrativeDAO {
	...
	* @return A list of Narrative
	...
	public List<Narrative> getAllNarrativesByUser(int volunteerId) {
		...
		List<Narrative> narratives = jdbcTemplate.query(sql, new Object[]{volunteerId}, new NarrativeMapper());
	...
	* @return A list of Narrative Objects
	...
	public List<Narrative> getNarrativesByVolunteer(int volunteerId, int patientId, int appointmentId) {
		...
		List<Narrative> narratives = jdbcTemplate.query(sql, new Object[]{volunteerId, patientId, appointmentId}, new NarrativeMapper());	
		return narratives;
	}
	...
	* @return A Narrative Object
	...
	public Narrative getNarrativeById(int narrativeId) {
		...
		return jdbcTemplate.queryForObject(sql, new Object[]{narrativeId}, new NarrativeMapper());
	}
	...
	public void addNarrative(Narrative narrative) {		
		...
		jdbcTemplate.update(sql, narrative.getTitle(), narrative.getContents(), narrative.getEditDate(), 
	...
	public void deleteNarrativeById(int narrativeId) {
		...
		jdbcTemplate.update(sql, narrativeId);
