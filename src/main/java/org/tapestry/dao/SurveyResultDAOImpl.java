...
public class SurveyResultDAOImpl implements SurveyResultDAO {
	...
	public List<SurveyResult> getSurveysByPatientID(int patientId) {
		...
		List<SurveyResult> results = jdbcTemplate.query(sql, new Object[]{patientId}, new SurveyResultMapper());
	...
	public SurveyResult getSurveyResultByID(int resultId) {
		...
		return jdbcTemplate.queryForObject(sql, new Object[]{resultId}, new SurveyResultMapper());
	}
	...
	public List<SurveyResult> getAllSurveyResults() {
		...
		List<SurveyResult> results = jdbcTemplate.query(sql, new SurveyResultMapper());
	...
	public List<SurveyResult> getAllSurveyResultsBySurveyId(int surveyId) {
		String sql = "SELECT survey_results.*, surveys.title, patients.firstname, patients.lastname FROM survey_results"
				...
				+ " ORDER BY survey_results.startDate ";
		List<SurveyResult> results = jdbcTemplate.query(sql, new Object[]{surveyId}, new SurveyResultMapper());
	...
	public List<SurveyResult> getSurveyResultByPatientAndSurveyId(int patientId, int surveyId) {
		String sql = "SELECT survey_results.*, surveys.title, patients.firstname, patients.lastname FROM survey_results"
				...
				+ " ORDER BY survey_results.startDate ";
		List<SurveyResult> results = jdbcTemplate.query(sql, new Object[]{patientId,surveyId}, new SurveyResultMapper());
	...
	public int countCompletedSurveys(int patientId) {
		...
		return jdbcTemplate.queryForInt(sql, new Object[]{patientId});
	}	
