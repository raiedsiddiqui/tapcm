...
public class Uploader {
	...
	public void Upload(byte[] fileBytes,String fileName,String directory,String keyLocation,String URL) throws Exception{		
		//UMOEventContext context = RequestContext.getEventContext();
        //String fileName = null;//context.getStringProperty( FileConnector.PROPERTY_ORIGINAL_FILENAME );
		//String directory = null;//context.getStringProperty( FileConnector.PROPERTY_DIRECTORY );
		//String keyLocation = null;//context.getStringProperty("keyLocation");
		//String URL = null; //context.getStringProperty("oscarURL");
