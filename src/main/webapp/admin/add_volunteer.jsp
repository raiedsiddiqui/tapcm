					...
					<fieldset>
						...
						<h2>Availability </h2>
									<table>
										...
										<tr>
											<td class="col-md-2"><select name="monFrom1" form="add_volunteer">
									...
									</select> TO <select name="monTo1" form="add_volunteer">
										<option value="0">...</option>
										<option value="11">08:00 AM</option>
										<option value="12">08:30 AM</option>
										<option value="13">09:00 AM</option>
									...
									<select name="monFrom2" form="add_volunteer">
										<option value="0">...</option>
										<option value="11">08:00 AM</option>
										<option value="12">08:30 AM</option>
										<option value="13">09:00 AM</option>
										...
										<option value="114">15:30 PM</option>
										<option value="115">16:00 PM</option>
									</select> TO <select name="monTo2" form="add_volunteer">
									<option value="0"></option>
										<option value="0">...</option>
										<option value="11">08:00 AM</option>
										<option value="12">08:30 AM</option>
										...
										<option value="115">16:00 PM</option>
											...
											<td>
											<select name="tueFrom1" form="add_volunteer">
									<option value="0"></option>
									...
									</select> TO <select name="tueTo1" form="add_volunteer">
									<option value="0"></option>
										<option value="21">08:00 AM</option>
										<option value="22">08:30 AM</option>
										<option value="23">09:00 AM</option>
									...
									<select name="tueFrom2" form="add_volunteer">
									<option value="0"></option>
										<option value="21">08:00 AM</option>
										<option value="22">08:30 AM</option>
										<option value="23">09:00 AM</option>
										...
										<option value="214">15:30 PM</option>
										<option value="215">16:00 PM</option>
									</select> TO <select name="tueTo2" form="add_volunteer">
									<option value="0"></option>
										<option value="21">08:00 AM</option>
										<option value="22">08:30 AM</option>
										<option value="23">09:00 AM</option>
										...
										<option value="215">16:00 PM</option>
											...
											<td>
											<select name="wedFrom1" form="add_volunteer">
										<option value="0"></option>
										...
										</select> TO <select name="wedTo1" form="add_volunteer">
										<option value="0"></option>
											<option value="31">08:00 AM</option>
											<option value="32">08:30 AM</option>
											<option value="33">09:00 AM</option>
										...
										<select name="wedFrom2" form="add_volunteer">
										<option value="0"></option>
											<option value="31">08:00 AM</option>
											<option value="32">08:30 AM</option>
											<option value="33">09:00 AM</option>
											...
											<option value="314">15:30 PM</option>
											<option value="315">16:00 PM</option>
										</select> TO <select name="wedTo2" form="add_volunteer">
										<option value="0"></option>
											<option value="31">08:00 AM</option>
											<option value="32">08:30 AM</option>
											<option value="33">09:00 AM</option>
											...
											<td>
											<select name="thuFrom1" form="add_volunteer">
										<option value="0"></option>
										...
										</select> TO <select name="thuTo1" form="add_volunteer">
										<option value="0"></option>
											<option value="41">08:00 AM</option>
											<option value="42">08:30 AM</option>
											<option value="43">09:00 AM</option>
										...
										<select name="thuFrom2" form="add_volunteer">
										<option value="0"></option>
											<option value="41">08:00 AM</option>
											<option value="42">08:30 AM</option>
											<option value="43">09:00 AM</option>
											...
											<option value="414">15:30 PM</option>
											<option value="415">16:00 PM</option>
										</select> TO <select name="thuTo2" form="add_volunteer">
										<option value="0"></option>
											<option value="41">08:00 AM</option>
											<option value="42">08:30 AM</option>
											<option value="43">09:00 AM</option>
											...
											<td>
											<select name="friFrom1" form="add_volunteer">
										<option value="0"></option>
										...
										</select> TO <select name="friTo1" form="add_volunteer">
										<option value="0"></option>
										<option value="51">08:00 AM</option>
											<option value="52">08:30 AM</option>
											<option value="53">09:00 AM</option>
										...
										<select name="friFrom2" form="add_volunteer">
										<option value="0"></option>
											<option value="51">08:00 AM</option>
											<option value="52">08:30 AM</option>
											<option value="53">09:00 AM</option>
											...
											<option value="514">15:30 PM</option>
											<option value="515">16:00 PM</option>
										</select> TO <select name="friTo2" form="add_volunteer">
										<option value="0"></option>
